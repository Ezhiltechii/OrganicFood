...
import com.sbtechnologies.organicfood.R;
...
public class CustomBottomNavigationView1 extends BottomNavigationView {
    ...
    public CustomBottomNavigationView1(@NonNull Context context) {
        super(context);
        init();
    }
    ...
    private void init() {
        ...
        mPaint.setColor(ContextCompat.getColor(getContext(), R.color.blue_500));
